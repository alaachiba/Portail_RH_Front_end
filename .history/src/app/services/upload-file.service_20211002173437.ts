...
/*
    const req = new HttpRequest('POST', `${this.baseUrl}/rest/api/file/upload`, formData, {
      reportProgress: true,
      responseType: 'json'
    });*/

    return this.http.post(`${this.baseUrl}/rest/api/file/upload`,formData,this.httpOptions);
  }
